...
public abstract class AbstractLTStepDescriptor extends StepDescriptor {

    private transient final static Logger log = Logger.getLogger(LTSeleniumStep.LTSeleniumStepDescriptor.class.getName());
    ...
    public ListBoxModel doFillCredentialsIdItems(final @AncestorInPath ItemGroup<?> context) {
        return LTCredentials.fillCredentialsIdItems(context);
    }
    public FormValidation doTestConnection(@QueryParameter("username") final String username, @QueryParameter("authkey") final String authkey) throws IOException, ServletException {
        return LTCredentials.testCredentials(username, authkey);
    }

    @Override public Set<? extends Class<?>> getRequiredContext() {
        return ImmutableSet.of(Run.class, TaskListener.class, LTCredentials.class);
    }
