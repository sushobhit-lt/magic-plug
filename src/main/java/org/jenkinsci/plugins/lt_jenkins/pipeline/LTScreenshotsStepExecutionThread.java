...
import org.jenkinsci.plugins.lt_jenkins.ScreenshotsBuildAction;
...
public class LTScreenshotsStepExecutionThread extends Thread {
    /*
     * starts and monitors the screenshots test in a seperate thread
     */
    Screenshots screenshotsApi;
    LTScreenshotsStep screenshotsStep;
    LTScreenshotsStep.LTScreenshotsStepExecution stepExecution;
    private final static Logger log = Logger.getLogger(LTScreenshotsStepExecutionThread.class.getName());


    Boolean useTestResult = false;
    public LTScreenshotsStepExecutionThread(Boolean useTestResult,
                                             Screenshots screenshotsApi,
                                             LTScreenshotsStep step,
                                             LTScreenshotsStep.LTScreenshotsStepExecution stepExecution) {
